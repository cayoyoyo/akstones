...
const porcelainImages = [
  ...
  { imageSrc: "/porcelain/BasicCemento.png", imageName: "Basic Cemento" },
  { imageSrc: "/porcelain/BasicNegro.png", imageName: "Basic Negro" },
  { imageSrc: "/porcelain/CalacataVaglie.png", imageName: "Calacata Vaglie" },
  { imageSrc: "/porcelain/Calacata.png", imageName: "Calacata" },
  { imageSrc: "/porcelain/CamargueArena.png", imageName: "Camargue Arena" },
  { imageSrc: "/porcelain/Carrara.png", imageName: "Carrara" },
  { imageSrc: "/porcelain/Corinto.png", imageName: "Corinto" },
  { imageSrc: "/porcelain/Iceberg.png", imageName: "Iceberg" },
  { imageSrc: "/porcelain/MacchiaVecchia.png", imageName: "Macchia Vecchia" },
];
    ...
    <>
      ...
      {filter === "all" || filter === "porcelain" ? (
        <div className="products-container">
          ...
          <div className="coverlam">
      <img src="coverlam.png" alt="Coverlam" />
    </div>
      ...
      {filter === "all" || filter === "quartz" ? (
        <div className="products-container">
          ...
          <p className="sizes">127"x64" (3/4")</p>
          <section className="layout">
