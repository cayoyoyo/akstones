...
function GalleryPage() {
  ...
  useEffect(() => {
    const fetchInstagramData = async () => {
      try {
        const userToken = "ZoRKjKco8Hiq42pbm4_PT8OdplY";
        const apiUrl = `https://graph.instagram.com/hra.usa/media?fields=id,caption,media_type,media_url,thumbnail_url,permalink&access_token=${userToken}`;
